        ...
        <form method="POST" action="{{ route("admin.lessons.update", [$lesson->id]) }}" enctype="multipart/form-data">
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <textarea rows="1"  class="form-control {{ $errors->has('short_text') ? 'is-invalid' : '' }}" name="short_text" id="short_text">{{ old('short_text', $lesson->short_text) }}</textarea>
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <textarea rows="1"  class="form-control {{ $errors->has('long_text') ? 'is-invalid' : '' }}" name="long_text" id="long_text">{{ old('long_text', $lesson->long_text) }}</textarea>
