            ...
            <form method="POST" action="{{ route('admin.students.update', [$student->id]) }}" enctype="multipart/form-data">
                ...
                <div class="col-xl-4 col-lg-4 col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text"
                            name="date" id="date" placeholder="YYYY-MM-DD" value="{{ old('date', $student->date) }}">
                        @if ($errors->has('date'))
                ...
                <div class="col-xl-4 col-lg-4 col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('nrc') ? 'is-invalid' : '' }}" type="text" name="nrc"
                            id="nrc" value="{{ old('nrc', $student->nrc) }}">
                        @if ($errors->has('nrc'))
                            <div class="invalid-feedback">
                                {{ $errors->first('nrc') }}
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" rows="1" id="address"
                ...
                <div class="col-xl-4 col-lg-4 col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('phone_no') ? 'is-invalid' : '' }}" type="text"
                            name="phone_no" id="phone_no" value="{{ old('phone_no', $student->phone_no) }}" required>
                ...
                <div class="col-xl-4 col-lg-4 col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('acca_student_no') ? 'is-invalid' : '' }}" type="text"
                            name="acca_student_no" id="acca_student_no"
                            value="{{ old('acca_student_no', $student->acca_student_no) }}">
                ...
                <div class="col-xl-4 col-lg-4 col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('subject') ? 'is-invalid' : '' }}" type="text"
                            name="subject" id="subject" value="{{ old('subject', $student->subject) }}">
                ...
                <div class="col-xl-4 col-lg-4 col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('exam_session_period') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('exam_session_period', $student->exam_session_period) }}">
                ...
                {{-- <div class="col-xl-4 col-lg-4 col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('old_student') ? 'is-invalid' : '' }}" type="text"
                            name="old_student" id="old_student" value="{{ old('old_student', $student->old_student) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('how_knew_acca') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Models\Student::HOW_KNEW_ACCA_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('how_knew_acca', $student->how_knew_acca) === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-xl-4 col-lg-4 col-12">
                    ...
                    <textarea rows="1" cols="1" class="form-control"  name="why_choose" id="why_choose">
