        ...
        <form method="POST" action="{{ route("admin.teachers.store") }}" enctype="multipart/form-data">
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="text" name="date_of_birth" id="date_of_birth" placeholder="YYYY-MM-DD"  value="{{ old('date_of_birth') }}" required>
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <textarea rows="1"  class="form-control ckeditor {{ $errors->has('parent_occupation') ? 'is-invalid' : '' }}" name="parent_occupation" id="parent_occupation">{!! old('parent_occupation') !!}</textarea>
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nation_and_religion') ? 'is-invalid' : '' }}" type="text" name="nation_and_religion" id="nation_and_religion" value="{{ old('nation_and_religion', '') }}" required>
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nrc') ? 'is-invalid' : '' }}" type="text" name="nrc" id="nrc" value="{{ old('nrc', '') }}" required>
                    @if($errors->has('nrc'))
                        <div class="invalid-feedback">
                            {{ $errors->first('nrc') }}
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <textarea rows="1"  class="form-control ckeditor {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{!! old('address') !!}</textarea>
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('start_date_of_employment') ? 'is-invalid' : '' }}" type="text" name="start_date_of_employment" id="start_date_of_employment" placeholder="YYYY-MM-DD"  value="{{ old('start_date_of_employment') }}" required>
            ...
            <div class="col-xl-4 col-lg-4 col-12">
                <div class="form-group">
                    ...
                    <textarea rows="1"  class="form-control ckeditor {{ $errors->has('attended_courses') ? 'is-invalid' : '' }}" name="attended_courses" id="attended_courses">{!! old('attended_courses') !!}</textarea>
