                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.students.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nrc" id="nrc" value="{{ old('nrc', '') }}">
                            @if($errors->has('nrc'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nrc') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="acca_student_no" id="acca_student_no" value="{{ old('acca_student_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="exam_session_period" id="exam_session_period" value="{{ old('exam_session_period', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="old_student" id="old_student" value="{{ old('old_student', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="how_knew_acca" id="how_knew_acca">
                                ...
                                @foreach(App\Models\Student::HOW_KNEW_ACCA_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('how_knew_acca', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
