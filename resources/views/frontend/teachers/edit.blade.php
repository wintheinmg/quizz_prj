    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.teachers.update", [$teacher->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.teacher.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $teacher->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $teacher->date_of_birth) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="age" id="age" value="{{ old('age', $teacher->age) }}" step="1" required>
                            @if($errors->has('age'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('age') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="parent_name" id="parent_name" value="{{ old('parent_name', $teacher->parent_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="parent_occupation" id="parent_occupation">{!! old('parent_occupation', $teacher->parent_occupation) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nation_and_religion" id="nation_and_religion" value="{{ old('nation_and_religion', $teacher->nation_and_religion) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nrc" id="nrc" value="{{ old('nrc', $teacher->nrc) }}" required>
                            @if($errors->has('nrc'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nrc') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_no" id="contact_no" value="{{ old('contact_no', $teacher->contact_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="address" id="address">{!! old('address', $teacher->address) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date_of_employment" id="start_date_of_employment" value="{{ old('start_date_of_employment', $teacher->start_date_of_employment) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="attended_courses" id="attended_courses">{!! old('attended_courses', $teacher->attended_courses) !!}</textarea>
