                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('teacher_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.teachers.index') }}">
                                    ...
                                    @can('course_category_access')
                                        <a class="dropdown-item" href="{{ route('frontend.course-categories.index') }}">
                                    ...
                                    @can('course_student_access')
                                        <a class="dropdown-item" href="{{ route('frontend.course-students.index') }}">
